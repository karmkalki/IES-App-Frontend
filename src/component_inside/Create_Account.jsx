    ...
    const [accData, setaccData] = useState({
      ...
      const handleSubmit = async (e) => {
       e.preventDefault();
        ...
        try {
          const response = await fetch('http://localhost:8080/createAcc', {
            method: 'POST',
            headers: {
      ...
      return (
         ...
         <div className="register-form">
             ...
             <p style={{fontSize:"30px",fontWeight:"400",marginTop:"10px"}}>Create User Account <FaUserShield style={{marginTop:"-7px"}} /></p>
